...
class Desktop {
    ...
    constructor(windows, wallpaper) {
        this.windows = windows;
        this.wallpaper = wallpaper;
    }
    createWindow(nwindow, addToWindows = true) {
    ...
    focusWindow(id, forceFocus = false) {
